...
export default function Desktop({ ong, categs, count }) {
          ...
          <div className="leftHalf">
            ...
            <div className="infoItem">
              ...
              <div style={classes.link}>
                <Typography>
                  <b>{count}</b> vizualizações nos últimos 30 dias
                </Typography>
              </div>
            </div>
            ...
            <div className="divButtons">
              {ong.facebook && (
                <Button
                  ...
                  target="_blank"
                  href={`${ong.facebook}`}
                  className="iconButton facebookBorder"
                >
                  <div>
                    <IconContext.Provider
                      value={{ color: "#3b5998", size: "3.5em" }}
                    >
                      <FaFacebookF />
                    </IconContext.Provider>
                  </div>
              ...
              {ong.instagram && (
                <Button
                  ...
                  target="_blank"
                  href={ong.instagram}
                  className="iconButton instagramBorder"
                >
          ...
          <div className="rightHalf ">
            ...
            {ong.picpay && (
              <Button
                ...
                target="_blank"
                href={ong.picpay}
                className="iconButton picPayBorder"
              >
                <div>
                  <IconContext.Provider
